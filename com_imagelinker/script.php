...
return new class () implements InstallerScriptInterface
{
    ...
    public function install(InstallerAdapter $adapter): bool
    {
        Factory::getApplication()->enqueueMessage(
            Text::_('COM_IMAGELINKER_INSTALL_SUCCESS'),
            'success'
        );
        return true;
    }
    ...
    {
        Factory::getApplication()->enqueueMessage(
            Text::_('COM_IMAGELINKER_UPDATE_SUCCESS'),
            'success'
        );
        return true;
    }
    ...
    {
        Factory::getApplication()->enqueueMessage(
            Text::_('COM_IMAGELINKER_UNINSTALL_SUCCESS'),
            'success'
        );
        return true;
    }
    ...
    {
        Factory::getApplication()->enqueueMessage(
            Text::_('COM_IMAGELINKER_POSTFLIGHT_COMPLETE'),
            'info'
        );
        return true;
    }
